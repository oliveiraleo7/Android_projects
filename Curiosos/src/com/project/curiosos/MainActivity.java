...
public class MainActivity extends Activity {
	...
	private Curiosidade textos = new Curiosidade();
	private int indice_atual = 0;
	private AdView adView;
	private static Display display;
	private LinearLayout layout;
	private BaixaJson baixaJson;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("antesThread", "antesThread");
        new BaixaJson(texto).execute("http://leonardolael.esy.es/curiosidades.php");
        Log.i("depoisThread", "depoisThread");
    }
